...
<body>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><a href="editarReceita.jsp?id=<%= receita.getId() %>">Editar</td>
            <td><a href="verReceita.jsp?id=<%= receita.getId() %>">Ver</td>
            <td><a href="excluirReceita.jsp?id=<%= receita.getId() %>">Excluir</td>
        </tr>
        <%
            }
        %>
